...
def validate():
    ...
    rf_casual = RandomForestRegressor(n_estimators=1000, min_samples_split = 11, random_state = 0, n_jobs = -1)
    ...
    rf_registered = RandomForestRegressor(n_estimators=1000, min_samples_split = 11, random_state = 0, n_jobs = -1)
...
if __name__ == '__main__':
    ...
    features = ['season','holiday','workingday','weather','temp','atemp','humidity','windspeed','time','weekday','year','monthCluster']
